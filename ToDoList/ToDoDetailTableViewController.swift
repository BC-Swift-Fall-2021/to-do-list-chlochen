...
//  ToDoList
//
//  Created by Chloe Chen on 9/26/21.
//
        ...
        LocalNotificationManager.isAuthorized { authorized in
            DispatchQueue.main.async {
                if !authorized && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User has not allowed notifications", message: "To receive alerts for reminders, open the settings app, select ToDoList > Notifications > Allow Notifications")
